...
## RESCU.PRM is reused as-is, not duplicated), ALOPT.PRM's headphones for
## AUDIO and its stopwatch for BEST TIMES.
...
const BEST_TIMES_MENU := "res://scenes/OptionsBestTimesMenu.tscn"
...
func _build() -> void:
	...
	page.add_button(3, "BEST TIMES", _open.bind(BEST_TIMES_MENU))
